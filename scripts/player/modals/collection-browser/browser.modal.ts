...
export class BrowserModal {
  ...
  show() {
    ...
    buttons.push(["Previous Page", [], "", undefined, undefined, "previous-page"]); // button index 8
    buttons.push(["Next Page", [], "", undefined, undefined, "next-page"]); // button index 9
    buttons.push(["Search", [], "", undefined, undefined, "search"]); // button index 10
